...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "Systarndra Fashion-Store",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "Systarndra Fashion-Store",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "Systarndra Fashion-Store",
    ...
    "welcome_sign": "Welcome Systarndra Fashion-Store",

    # Copyright on the footer
    "copyright": "oxytech-Store Ltd",
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'adesinaolaoluwamarvelous@gmail.com'
EMAIL_HOST_PASSWORD = 'fbpd nwww fhae rwsf'
